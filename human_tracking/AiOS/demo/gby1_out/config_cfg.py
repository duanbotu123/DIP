...
trainset_2d = []
trainset_partition = dict(AGORA_MM=0.4, BEDLAM=0.7, COCO_NA=1)
trainset_humandata = []
testset = 'INFERENCE'
...
camera_3d_size = 2.5
bbox_ratio = 1.2
output_dir = '/home/juyonggroup/xiangjun/github/AiOS/config/../exps62'
model_dir = None
vis_dir = None
log_dir = None
result_dir = '/home/juyonggroup/xiangjun/github/AiOS/config/../exps62/result'
code_dir = None
agora_benchmark = 'na'
data_strategy = 'balance'
total_data_len = 'auto'
cur_dir = '/home/juyonggroup/xiangjun/github/AiOS/config'
root_dir = '/home/juyonggroup/xiangjun/github/AiOS/config/..'
data_dir = '/home/juyonggroup/xiangjun/github/AiOS/config/../dataset'
