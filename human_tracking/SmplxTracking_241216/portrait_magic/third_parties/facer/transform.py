...
def get_face_align_matrix_celebm(
    ...
    border = int(target_size * 0.2)
    target_pts = torch.as_tensor([[border, border], [target_size-border,border], [target_size-border, target_size-border], [border, target_size-border]]).to(face_pts)
