...
from .common.nets.module import PositionNet, HandRotationNet, FaceRegressor, BoxNet, HandRoI, FaceRoI, BodyRotationNet
from ...dmm_models.smplx.human_models import smpl_x
...
import os
from .main_utils.decoder.face_decoder import model as face_model
from .main_utils.decoder.hand_decoder import model as hand_model
...
def get_model():
    ...
    hand_decoder = build_posenet(hand_model)
    ...
    face_decoder = build_posenet(face_model)
