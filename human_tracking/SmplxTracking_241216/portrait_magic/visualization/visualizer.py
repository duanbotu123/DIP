...
def load_image(img_path, sub_vis, index):
    imgs = []
    for cam in sub_vis:
        image_name = os.path.join(img_path, cam, "ori_imgs" ,'{:06d}.jpg'.format(index))
        assert os.path.exists(image_name), 'Image {} not found'.format(image_name)
