...
def convert_kps(
    ...
    #### for left,right hand root
    out_keypoints[:, 91] = out_keypoints[:, 9]
    out_keypoints[:, 112] = out_keypoints[:, 10]

    out_confidence[:, 91] = out_confidence[:, 9]
    out_confidence[:, 112] = out_confidence[:, 10]
